...
export default class PostPreview extends React.Component {
  render() {
    ...
    return <div>
        ...
        <div className="bg-grey-1 pv4" style="background: yellow;">
        ...
        <div className="bg-off-white pv4" style="background: yellow;">
          <div className="ph3 mw7 center">
            ...
            <div className="tc">
              <a href="#" className="btn raise">See all products Emmely</a>
            </div>
          </div>
        </div>
